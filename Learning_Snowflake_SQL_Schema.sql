create or replace TABLE LEARNING_SQL.PUBLIC.REGION (
	R_REGIONKEY NUMBER(38,0),
	R_NAME VARCHAR(25),
	R_COMMENT VARCHAR(152)
);
create or replace TABLE LEARNING_SQL.PUBLIC.NATION (
	N_NATIONKEY NUMBER(38,0),
	N_NAME VARCHAR(25),
	N_REGIONKEY NUMBER(38,0),
	N_COMMENT VARCHAR(152)
);
create or replace TABLE LEARNING_SQL.PUBLIC.SUPPLIER (
...
create or replace TABLE LEARNING_SQL.PUBLIC.CUSTOMER (
...
create or replace TABLE LEARNING_SQL.PUBLIC.PART (
...
create or replace TABLE LEARNING_SQL.PUBLIC.ORDERS (
...
create or replace TABLE LEARNING_SQL.PUBLIC.LINEITEM (
...
create or replace TABLE LEARNING_SQL.PUBLIC.PARTSUPP (
